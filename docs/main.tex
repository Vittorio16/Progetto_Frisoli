...
Ponendo come $x_0$ l'ascissa del centro del carrello, che si sposta con legge oraria costante pari a:\[x_0=Acos(\omega t)\]
...
Deriviamo ora per ottenere le velocità:\[\dot x_n=-A\omega sin(\omega t)+\sum_{i=1}^{n} l_i\dot\theta_i cos(\theta_i)\hspace{1cm}\dot y_n=\sum_{i=1}^{n}l_i\dot\theta_i sin(\theta_i)\hspace{1cm}n\in[1,2]\]
...
\[\dot x_n^2=(-A\omega sin(\omega t)+\sum_{i=1}^{n}l_i\dot\theta_i cos(\theta_i))^2=\]\[=A^2\omega ^2 sin^2 (\omega t)- 2A\omega sin(\omega t)\sum_{i=1}^{n}l_i\dot\theta_icos(\theta_i)+\sum_{k=1}^{n}\sum_{j=1}^{n}l_kl_k\dot\theta_k \dot\theta_j cos(\theta_k)cos(\theta_j)\]
\\Sostituiamo 1 e 2 ad n, per ottenere $T_1$ e $T_2$, e quindi l'energia cinetica totale pari a: \[T=T_1+T_2=\]\[=\frac{M_{tot}}{2}(A^2\omega ^2sin^2(\omega t)-2A\omega sin(\omega t)l_1\dot \theta_1 cos(\theta_1)+l_1^2\dot \theta_1^2)+\]\[+\frac{m_2}{2}(l_2^2\theta_2^2-2A\omega sin(\omega t)l_2\dot\theta_2cos(\theta_2)+2l_1l_2\dot\theta_1\dot\theta_2cos(\theta_1-\theta_2))\]\\
Con $M_{tot}=m_1+m_2$.
...
A questo punto possiamo esplicitare la Lagrangiana: \[L=T-U=\]\[=\frac{M_{tot}}{2}(A^2\omega ^2sin^2(\omega t)-2A\omega sin(\omega t)l_1\dot \theta_1 cos(\theta_1)+l_1^2\dot \theta_1^2+2gl_1cos(\theta_1))+\]\[+\frac{m_2}{2}(l_2^2\dot\theta_2^2-2A\omega sin(\omega t)l_2\dot\theta_2cos(\theta_2)+2l_1l_2\dot\theta_1\dot\theta_2cos(\theta_1-\theta_2)+2gl_2cos(\theta_2))\]
...
\[\frac{\partial L}{\partial \theta_1}=M_{tot}(A\omega sin(\omega t)l_1\dot\theta_1 sin(\theta_1)-2gl_1sin(\theta_1))-m_2(l_1l_2\dot\theta_1\dot\theta_2sin(\theta_1-\theta_2))\]
\[\frac{\partial L}{\partial \dot\theta_1}=M_{tot}(l_1^2\dot \theta_1-A\omega sin(\omega t)l_1cos(\theta_1))+m_2(l_1l_2\dot\theta_2cos(\theta_1-\theta_2))\]
A questo punto deriviamo nel tempo:
\[\frac{d}{dt}\frac{\partial L}{\partial \dot\theta_1}=M_{tot}(l_1^2\ddot\theta_1+A\omega sin(\omega t)l_1\dot \theta_1 sin(\theta_1)-A\omega^2 cos(\omega t)l_1cos(\theta_1))+\]\[+m_2(l_1l_2\ddot\theta_2cos(\theta_1-\theta_2)-l_1l_2\dot\theta_2(\dot\theta_1-\dot\theta_2)sin(\theta_1-\theta_2))\]
Continuando con la seconda equazione:
\[\frac{\partial L}{\partial \theta_2}=m_2(l_1l_2\dot\theta_1\dot\theta_2sin(\theta_1-\theta_2)+A\omega sin(\omega t)l_2\dot\theta_2sin(\theta_2)-gl_2sin(\theta_2))\]
\[\frac{\partial L}{\partial \dot\theta_2}=m_2(l_2^2\dot\theta_2-A\omega sin(\omega t)l_2cos(\theta_2)+l_1l_2\dot\theta_1cos(\theta_1-\theta_2))\]
A questo punto derivimao nel tempo:
\[\frac{d}{dt}\frac{\partial L}{\partial \dot\theta_2}=m_2(l_2^2\ddot\theta_2-A\omega^2cos(\omega t)l_2cos(\theta_2)+A\omega sin(\omega t)l_2\dot\theta_2sin(\theta_2)+\]\[+l_1l_2\ddot\theta_1cos(\theta_1-\theta_2)-l_1l_2\dot\theta_1(\dot\theta_1-\dot\theta_2)sin(\theta_1-\theta_2))\]
